/**
 * This class contains all the Functionality that Selenium can provide
 * And all are implemeneted as methods 
 * Author - Chittaranjan Swain added on 5th Sept 2022
 */
...
/**
 * @author Chitta added on 5th Sept 2022
 *
 */
public class Action extends BaseClass {
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/MyStoreProject/ws/MyStoreProject/ScreenShots/" + filename
				+ "_" + dateName + ".png";
		return destination; // change it to newImageString
	}
